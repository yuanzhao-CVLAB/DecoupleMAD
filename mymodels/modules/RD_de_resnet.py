...
class ResNet(nn.Module):
    ...
    def __init__(
        ...
        # self.vq1 = VectorQuantizerEMA(1024,1024)
        # self.vq2 = VectorQuantizerEMA(1024,512)
        # self.vq3 = VectorQuantizerEMA(1024,256)
    ...
    def _forward_impl(self, x: Tensor,student_out=None) -> Tensor:
        ...
        # lossa,feature_a,_,_ = self.vq1(feature_a)

        feature_b = self.layer2(feature_a)  # 256*16*16->128*32*32
        # lossb,feature_b,_,_ = self.vq1(feature_b)
        feature_c = self.layer3(feature_b)  # 128*32*32->64*64*64
        # lossc,feature_c,_,_ = self.vq1(feature_c)
