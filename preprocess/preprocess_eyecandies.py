...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_path', default='/home/zhaoyuan/disk2/data/Eyecandies', type=str, help="Original Eyecandies dataset path.")
    parser.add_argument('--target_dir', default='./EyeRGBNorm', type=str, help="Processed Eyecandies dataset path")
    ...
    for category_dir in categories_list:
        ...
        for i in tqdm.tqdm(range(0, num_train_files),desc="pc_copy"):
            ...
            copyfile(os.path.join(category_train_path,str(i).zfill(3)+'_normals.png'),os.path.join(category_target_train_good_xyz_path, str(i).zfill(3)+'.png'))
        ...
        for i in tqdm.tqdm(range(0, num_test_files),desc="preprocess"):
            ...
            if np.any(mask):
                ...
                copyfile(os.path.join(category_test_path, str(i).zfill(2) + '_normals.png'),
                         os.path.join(category_target_test_bad_xyz_path, str(i).zfill(3) + '.png'))
                ...
                copyfile(os.path.join(category_test_path, str(i).zfill(2) + '_normals.png'),
                         os.path.join(category_target_test_good_xyz_path, str(i).zfill(3) + '.png'))
